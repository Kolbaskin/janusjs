...
(function(Class, alias, arraySlice, arrayFrom, global) {
    ...
    var Manager = Ext.ClassManager = {
        ...
        instantiate: function() {
            ...
            if(args[0] && args[0].scope) {
                if(args[0].scope.src)
                    args[0].src = args[0].scope.src
                if(args[0].scope.config)
                    args[0].config = args[0].scope.config
                if(args[0].scope.request)
                    args[0].request = args[0].scope.request
                if(args[0].scope.response)
                    args[0].response = args[0].scope.response
                if(args[0].scope.user)
                    args[0].user = args[0].scope.user
