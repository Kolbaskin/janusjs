            ...
            Ext.apply(Loader, {
                ...
                loadScriptFile: function(filePath, onLoad, onError, scope, synchronous) {
                    try{
                        ...
                        if(filePath.indexOf('/protected/modules/') != -1) {
                            filePath =  filePath.replace('/protected/', '/static/admin/');
                            this.requireFile(filePath);
                        } else
                        if(filePath.indexOf('/protected/Desktop/modules/') != -1) {
                            filePath =  filePath.replace('/protected/Desktop/', '/static/admin/');
                            this.requireFile(filePath);
                        }
                    }
                    onLoad.call(scope);
                ...
                requireFile: function(file) {
                    ...
                    if(out) {
                        return this.requireFromString(out, file)
                    }
                }
            });
        }
