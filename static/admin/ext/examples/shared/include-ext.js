...
_DefaultTheme_ =  localStorage.getItem('DefaultTheme') || Config.DefaultTheme;
...
(function() {
    ...
    var scriptEls = document.getElementsByTagName('script'),
        ...
        theme = getQueryParam('theme') || _DefaultTheme_,
    ...
    extPrefix = useDebug ? '/build/ext-all-debug' : '/build/ext-all';
