...
Ext.define('Ext.ux.ImageCrop', {
  ...
  ,reconf: function(cfg) {
      //this.image.setWidth(cfg.rectWidth)
      //this.image.setHeight(cfg.rectHeight)
      //this.image.setXY(cfg.rectX, cfg.rectY)
      //this.setWidth(cfg.width)
      //this.setHeight(cfg.height)
      
      this.el.setStyle({
          background: 'url('+cfg.src+') no-repeat left top'
      });
      
      this.image.el.dom.style.backgroundImage = 'url('+cfg.src+')'
      this.src = cfg.src
